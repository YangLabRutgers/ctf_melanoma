...
def main():
    ...
    # 3. Intersect on shared patients to ensure clean alignment
    ...
    # 4. Explicitly map your patient IDs directly to their matched RNA Sample ID names
    patient_to_sample = {
        '1009': 'D19-11979',
        '1098': 'D19-11975', 
        '1224': 'D19-11983', 
        ...
        '776':  'D19-11972',
        '856':  'D19-11980',
        '620':  'D21-194011'  # <-- Change this exact line!
    }

    # REMOVED THE DROPPING FILTERS FOR 620 HERE SO DATA FLOWS THROUGH CLEANLY

    # Apply the unified sample IDs to both modalities
    X_atac.obs['joint_sample_id'] = X_atac.obs['patient_id'].map(patient_to_sample).astype(str)
    X_rna.obs['joint_sample_id'] = X_rna.obs['patient_id'].map(patient_to_sample).astype(str)

    print(overlapping_patients)
